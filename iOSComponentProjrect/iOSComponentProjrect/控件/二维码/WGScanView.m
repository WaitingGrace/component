...
- (void)drawRect:(CGRect)rect{
    ...
    descLabel.text = String(@"将二维码/条码放入框内，即可自动扫描");
    ...
    [myCode setTitle:String(@"我的二维码") forState:UIControlStateNormal];
