//
//  WGHDropMenuFilterSectionHeader.m
//  
//
...
@interface WGDropMenuFilterSectionHeader()
...
@implementation WGDropMenuFilterSectionHeader
...
- (void)setDropMenuModel:(WGDropMenuModel *)dropMenuModel {
    ...
    self.details.hidden = (dropMenuModel.filterCellType == WGDropMenuFilterCellTypeInput  ||
                           dropMenuModel.filterCellType == WGDropMenuFilterCellTypeSingleInput )? YES:NO;
