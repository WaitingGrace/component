...
@implementation WGDropMenuModel
...
- (NSArray *)creatNormalDropMenuData {
    ...
    for (NSInteger index = 0 ; index < line3.count; index++) {
        ...
        dropMenuModel.filterCellType = WGDropMenuFilterCellTypeTagCollection;
        [dataArray3 addObject:dropMenuModel];
    }
...
- (NSArray *)creaDropMenuData {
    ...
    for (NSInteger index = 0; index < sectionHeaderTitles.count; index++) {
        ...
        if (index == 0) {
            ...
            dropMenuModel.filterCellType = WGDropMenuFilterCellTypeTag;
        } else if (index == 1) {
            ...
            dropMenuModel.filterCellType = WGDropMenuFilterCellTypeInput;
            ...
            dropMenuModel.filterCellType = WGDropMenuFilterCellTypeSingleInput;
        }
