//
//  WGLinkageSheetView.m
//

#import "WGLinkageSheetView.h"
#import "WGLinkageSheetLeftCell.h"
#import "WGLinkageSheetRightCell.h"


@implementation WGPathResponseView
...
@interface WGLinkageSheetView ()<UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource, WGLinkageSheetLeftCellDataSourse, WGLinkageSheetRightCellDataSourse>
...
@implementation WGLinkageSheetView
...
- (void)configTableView {
    ...
    WGPathResponseView *leftBgView = [[WGPathResponseView alloc]initWithFrame:self.leftTableView.bounds];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (tableView == _leftTableView) {
        WGLinkageSheetLeftCell *cell = [WGLinkageSheetLeftCell createCellWithTableView:tableView ];
        ...
        WGLinkageSheetRightCell *cell = [WGLinkageSheetRightCell createCellWithTableView:tableView];
