//
//  WGLinkageSheetView.h
//

#import <UIKit/UIKit.h>

@interface WGPathResponseView : UIView
...
@protocol WGLinkageSheetViewDataSource <NSObject>
...
@interface WGLinkageSheetView : UIView

@property (nonatomic, weak, nullable) id <WGLinkageSheetViewDataSource> dataSource;
