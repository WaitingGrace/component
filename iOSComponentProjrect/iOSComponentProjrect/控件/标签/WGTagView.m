...
- (void)addTag: (WGTag *)tag {
    NSParameterAssert(tag);
    WGTagButton *btn = [WGTagButton buttonWithTag: tag];
...
- (void)insertTag: (WGTag *)tag atIndex: (NSUInteger)index {
    NSParameterAssert(tag);
