...
#define updateURL @"version/queryVersion?appCode=App001&platForm=ios"
#define versionURL @"http://itunes.apple.com/cn/lookup?id=1432518361"
#define appURL @"https://itunes.apple.com/cn/app/id1432518361?mt=8"
#define appStoreCode @"1432518361"
...
- (void)versionReminderMessage:(NSString *)message{
    ...
    UIAlertAction * action = [UIAlertAction actionWithTitle:@"立即更新" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        NSDictionary*dict = [NSDictionary dictionaryWithObject:appStoreCode forKey:SKStoreProductParameterITunesItemIdentifier];
