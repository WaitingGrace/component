...
#pragma mark - 雷达图背景风格
@interface WGPolygonalRadarBgStyleConfig : NSObject

@property (nonatomic, assign) ENUM_WGPOLYGONALRADAR_BG_STYLE      bgStyle;/**< 背景风格 */
@property (nonatomic, assign) ENUM_WGPOLYGONALRADAR_LINE_STYLE    symmetryAxisStyle;/**< 对称轴线风格 */
...
@class WGPolygonalRadarBorderStyleConfig;
@class WGPolygonalRadarFillStyleConfig;
@class WGPolygonalRadarVertexStyleConfig;

@interface WGPolygonalRadarStyleConfig : NSObject

@property (nonatomic, assign) CGFloat                           animationDuration;/**< 显示动画时长 */
@property (nonatomic, assign) BOOL                              showPolygonalBorder;/**< 显示多边形边框 */
@property (nonatomic, strong) WGPolygonalRadarBorderStyleConfig *borderStyleConfig;/**< 边框风格 */
@property (nonatomic, assign) BOOL                              showPolygonalFill;/**< 显示多边形填充 */
@property (nonatomic, strong) WGPolygonalRadarFillStyleConfig   *fillStyleConfig;/**< 填充风格 */
@property (nonatomic, assign) BOOL                              showPolygonalVertexIcon;/**< 显示多边形顶点Icon */
@property (nonatomic, strong) WGPolygonalRadarVertexStyleConfig *vertexStyleConfig;/**< 顶点风格 */

@end

#pragma mark - 雷达图边框风格
@interface WGPolygonalRadarBorderStyleConfig : NSObject

@property (nonatomic, assign) ENUM_WGPOLYGONALRADAR_LINE_STYLE        borderStyle;/**< 边框线风格 */
...
#pragma mark - 雷达图填充风格
@interface WGPolygonalRadarFillStyleConfig : NSObject

@property (nonatomic, assign) ENUM_WGPOLYGONALRADAR_FILL_STYLE        fillStyle;/**< 填充风格 */
...
#pragma mark - 雷达图顶点风格
@interface WGPolygonalRadarVertexStyleConfig : NSObject

@property (nonatomic, assign) ENUM_WGPOLYGONALRADAR_VERTEX_ICON_STYLE vertexStyle;/**< 顶点风格 */
