...
typedef NS_ENUM(NSUInteger, WGBadgeViewAlignment)
{
    WGBadgeViewAlignmentTopLeft = 1,
    WGBadgeViewAlignmentTopRight,
    WGBadgeViewAlignmentTopCenter,
    WGBadgeViewAlignmentCenterLeft,
    WGBadgeViewAlignmentCenterRight,
    WGBadgeViewAlignmentBottomLeft,
    WGBadgeViewAlignmentBottomRight,
    WGBadgeViewAlignmentBottomCenter,
    WGBadgeViewAlignmentCenter
};
...
@property (nonatomic, assign) WGBadgeViewAlignment badgeAlignment UI_APPEARANCE_SELECTOR;
