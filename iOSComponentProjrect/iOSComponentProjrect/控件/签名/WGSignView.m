...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.beizerPath setLineWidth:3];
    }
    return self;
}
...
- (UIImage *)getSignatureImage {
    ...
    NSString *path = [NSString stringWithFormat:@"%@/Documents/Image/MineSIGN.PNG", NSHomeDirectory()];
    //用png是透明的
