...
@interface WGCADisplayLineImageView ()
{
    int tmp;
}
@property (nonatomic) NSUInteger currentFrameIndex;
@property (nonatomic,strong) WGCADisplayLineImage *animatedImage;
...
@end
@implementation WGCADisplayLineImageView
...
-(void)setImage:(UIImage *)image
{
    ...
    self.accumulator = 0;
    if ([image isKindOfClass:[WGCADisplayLineImage class]] && image.images) {
        ...
        self.animatedImage = (WGCADisplayLineImage *)image;
...
-(void)setAnimatedImage:(WGCADisplayLineImage *)animatedImage
{
