...
-(void)viewDidLoad {
    ...
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:String(@"返回") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
-(void)addCloseButton {
    ...
    CGFloat closeBtnWidth = 38;
    CGFloat closeBtnHeight = closeBtnWidth;
    CGRect viewFrame = self.view.frame;
    closeBtn.frame = (CGRect){CGRectGetMaxX(viewFrame) - closeBtnWidth-19, CGRectGetMaxY(viewFrame) - closeBtnHeight-19, closeBtnWidth, closeBtnHeight};
