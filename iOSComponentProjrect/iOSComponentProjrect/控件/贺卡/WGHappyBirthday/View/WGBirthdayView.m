...
@interface WGBirthdayView () <CAAnimationDelegate>
...
- (UILabel *)getLabel:(CGRect)frame text:(NSString *)text {
    ...
    label.textColor = UIColorFromRGB(0xffc30228);
...
- (void)animationForBirthdayHeart {
    ...
    [happyBirthdayAnimation setValue:@(WGBirthdayAnimationTypeHappyBirthdayShow) forKey:YKBirthdayAnimationIdentifier];
...
- (void)animationForBirthdayLid {
   ...
   for (NSInteger i = 1; i < 40; i++) {
    ...
    [birthdayLidAnimationGroup setValue:@(WGBirthdayAnimationTypeLidGroup) forKey:YKBirthdayAnimationIdentifier];
...
- (void)animationForHappyBirthdayOpacity {
    ...
    [opacityAnimationGroup setValue:@(WGBirthdayAnimationTypeHappyBirthdayHidden) forKey:YKBirthdayAnimationIdentifier];
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag {
    ...
    if (WGBirthdayAnimationTypeLidGroup == keyPath) {
        [self animationForBirthdayHeart];
        [self animationForBirthdayMusic];
    } else if (WGBirthdayAnimationTypeHappyBirthdayShow == keyPath) {
        [self animationForHappyBirthdayOpacity];
    } else if (WGBirthdayAnimationTypeHappyBirthdayHidden == keyPath) {
