...
@interface SimpleLinkageSheetController ()<WGLinkageSheetViewDataSource>
...
- (void)setupUI {
    ...
    self.linkageSheetView = [[WGLinkageSheetView alloc]initWithFrame:CGRectMake(0, 0, 300, 300)];
