...
@implementation NSString (WGPinYin)
...
@implementation NSArray (WGPinYin)
...
- (NSArray *)arrayWithPinYinFirstLetterFormat{
    ...
    for (WGPinYinModel *user in self) {
        NSString *firstLetter = [user.trueName getFirstLetter];
    ...
    for (int i = 'A'; i <= 'Z'; i++) {
        ...
        NSMutableArray *array = dict[firstLetter];
        if ([array count]) {
            [array sortUsingComparator:^NSComparisonResult(WGPinYinModel *obj1, WGPinYinModel *obj2) {
                NSString *word1 = obj1.trueName;
                NSString *word2 = obj2.trueName;
